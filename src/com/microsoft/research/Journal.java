...
public class Journal {
    ...
    @XmlSchemaType(name = "unsignedInt")
    protected Long id;
    @XmlElementRef(name = "ISSN", namespace = "http://research.microsoft.com", type = JAXBElement.class)
    protected JAXBElement<String> issn;
     ...
     *     
     */
    public JAXBElement<String> getISSN() {
        return issn;
    }
     ...
     *     
     */
    public void setISSN(JAXBElement<String> value) {
        this.issn = ((JAXBElement<String> ) value);
    }
